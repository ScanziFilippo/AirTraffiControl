<?php
    ...
    if ($connessione->connect_errno)
    {
        ...
        try{
            ...
            while($connessione->query("SELECT * FROM parcheggi WHERE id = '$n' AND aeroporto_id = '$_SESSION[aeroporto_id]'")->num_rows > 0){
                $n++;
            }
            $connessione->query("INSERT INTO parcheggi (id, stato, aeroporto_id) VALUES ('$n','Libero', '$_SESSION[aeroporto_id]')");
